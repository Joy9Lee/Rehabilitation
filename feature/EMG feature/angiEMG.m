...
%     SynDataA.tonE{i}=SynDataA.synEMG{i}(SynDataA.loc0(i) : SynDataA.loc(i),:);         %shoulder angle
%     ang.shdAton{i}=ang.shdA{i}(SynDataA.loc0(i) : SynDataA.loc(i));
% end
% for i=1:length(SynDataU.name)
%     SynDataU.tonE{i}=SynDataU.synEMG{i}(SynDataU.loc0(i) : SynDataU.loc(i),:);         %shoulder angle
%     ang.shdCton{i}=ang.shdC{i}(SynDataU.loc0(i) : SynDataU.loc(i));
% end
