...
for i=1:length(cmpEMGA.name)            %affect
    ...
    if dispEMGU
        ...
        for j=1:7
            subplot(7,1,j)
            plot(cmpEMGA.EMGU{i}(:,j))
        end
    end
    [H{i},W{i},R(i),D(i)]=ExtractSynergy(cmpEMGA.EMG{i},NA,1000,5,1);
    [H2{i},W2{i},R2(i),D2(i)]=ExtractSynergy(cmpEMGA.EMGU{i},NA,1000,5,1);
...
for i=1:length(cmpEMGH.name)            %healthy
    ...
    [H3{i},W3{i},R3(i),D3(i)]=ExtractSynergy(cmpEMGH.EMGR{i},NH,1000,5,1);
    [H4{i},W4{i},R4(i),D4(i)]=ExtractSynergy(cmpEMGH.EMGL{i},NH,1000,5,1);
